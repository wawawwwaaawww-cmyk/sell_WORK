...
class SurveyService:
    ...
    def __init__(self, session: AsyncSession):
        ...
        self.questions = {
            "q1": {
                "text": "1. Какой опыт в инвестициях вы имеете?",
                "options": {
            ...
            "q2": {
                "text": "2. Какая у вас основная цель в сфере финансов на ближайший год?",
                "options": {
            ...
            "q3": {
                "text": "3. Как срочно вы хотите решить свой финансовый вопрос?",
                "options": {
            ...
            "q4": {
                "text": "4. С какой суммы готовы начать инвестировать?",
                "options": {
            ...
            "q5": {
                "text": "5. Готовы ли вы инвестировать в своё обучение, если увидите, что это поможет достичь цели?",
                "options": {
        ...
        self.confirmations = {
            "q1": {
                ...
                "crypto_long": (
                    ...
                    "просто держать сильные активы. Тут хорошо работает стейкинг. А какая у тебя основная цель в сфере финансов "
                    "на ближайший год?"
                ),
                "stocks": (
                    "Здорово 👌 Значит, у тебя уже есть опыт с традиционными активами. В крипте тоже есть аналоги фондового "
                    "рынка — крипто-ETF или диверсифицированные портфели.\n"
                    "Скажи, а какая у тебя цель на ближайший год в финансах?"
                ),
                "deposit": (
                    ...
                    "А какая у тебя цель в сфере финансов на ближайший год?"
                ),
                "no_experience": (
                    ...
                    "Скажи, а какая у тебя основная цель в финансах на ближайший год?"
                ),
            },
            "q2": {
                "passive_income": (
                    "Отличная цель 💡 Пассивный доход в крипторынке можно строить через стейкинг или DeFi-инструменты.\n"
                    "А скажи, как срочно ты хочешь прийти к этой цели?"
                ),
                "safety_net": (
            ...
            "q4": {
                "under_10": (
                    ...
                    "А скажи, готов ли ты инвестировать не только деньги, но и время/ресурсы в обучение, если увидишь, что это "
                    "реально поможет достичь цели?"
                ),
                "10_100": (
                ...
                "100_500": (
                    "Отличная сумма для начала 👍 Уже можно собрать мини-портфель: часть в стейблкоинах, часть в топовых "
                    "криптомонетах, плюс попробовать DeFi.\n"
                    "А готов ли ты вложить немного в обучение, чтобы использовать эту сумму максимально эффективно?"
                ),
                "500_1000": (
                    ...
                    "А готов ли ты инвестировать часть ресурсов в обучение, чтобы избежать ошибок и быстрее прийти к результату?"
                ),
                "over_1000": (
                    ...
                    "А если обучение позволит кратно повысить эффективность этой суммы — ты готов инвестировать в него?"
                ),
            },
            "q5": {
                "yes": (
