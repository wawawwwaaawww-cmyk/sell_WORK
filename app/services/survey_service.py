        ...
        self.confirmations = {
            "q1": {
                "trading": (
                    ...
                    "*А теперь скажи, какая у тебя основная цель в финансах на ближайший год?*\n"
                    "Вопрос 2/5"
                ),
                "crypto_long": (
            ...
            "q2": {
                "passive_income": (
                    ...
                    "*Как срочно вы хотите решить свой финансовый вопрос?*\n"
                    "Вопрос 3/5"
                ),
                "safety_net": (
            ...
            "q3": {
                "one_month": (
                    ...
                    "С какой суммы готовы начать инвестировать?\n"
                    "Вопрос 4/5"
                ),
                "three_months": (
            ...
            "q4": {
                "under_10": (
                    ...
                    "*А как думаешь, если будет видно, что обучение ускоряет прогресс — готов ли ты в него инвестировать?*\n"
                    "Вопрос 5/5"
                ),
                "ten_to_hundred": (
