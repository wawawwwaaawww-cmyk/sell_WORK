...
from app.models import FunnelStage, Lead, LeadStatus, User
...
class ManagerNotificationService:
    ...
    def _build_status_text(self, user: User, consultation_dt: Optional[datetime]=None) -> str:
    ...
    def _build_lead_channel_keyboard(self, lead_id: int, user_id: int) -> InlineKeyboardMarkup:
        ...
        builder.button(
            ...
            callback_data=f"consult_reschedule:{user_id}",
        )
        builder.adjust(1)
