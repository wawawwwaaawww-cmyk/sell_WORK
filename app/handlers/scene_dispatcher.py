...
_SCENE_TRIGGER_MAP: Dict[str, str] = {
    ...
    "survey:q1:trading": "callback:survey_answer",
    "survey:q1:crypto_long": "callback:survey_answer",
    "survey:q1:stocks": "callback:survey_answer",
    "survey:q1:deposit": "callback:survey_answer",
    "survey:q1:no_experience": "callback:survey_answer",
